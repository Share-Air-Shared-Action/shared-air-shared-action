...
// Build the SQL query
$query = 'SELECT DISTINCT metone.device, stationarylocations.latitude, stationarylocations.longitude FROM metone INNER JOIN stationarylocations ON (metone.unit_id = stationarylocations.unit_id)';
