...
// Build the SQL query
$query = "SELECT time AS x, measured_value AS y FROM airterrier WHERE measurement_type = 'CO concentration' AND session_title = $1 AND season = $2 ORDER BY time";
...
$returnarray = ["x" => $xarray, "y" => $yarray, "type" => "scatter", "name" => "CO (ppm)"];
