...
// Build the SQL query
$query = "SELECT latitude, longitude, measured_value as data FROM airterrier WHERE measurement_type = 'CO concentration' AND session_title = $1 AND season = $2 AND error IS DISTINCT FROM 1  ORDER BY time";
