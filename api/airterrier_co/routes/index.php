...
// Build the SQL query
$query = "SELECT latitude, longitude, measured_value as data FROM airterrier WHERE measurement_type = 'CO concentration' AND session_title = $1 AND season = $2 ORDER BY time";
