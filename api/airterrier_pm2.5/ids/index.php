...
// Build the SQL query
$query = "SELECT DISTINCT session_title, upper(SUBSTRING(session_title, 1, 2)) as community, season FROM airterrier WHERE measurement_type = 'Particulate Matter' AND season = $1";
