...
(select season,to_char(created_at,'HH24')::integer tod, pm25_cf_atm_ugm3 from purpleair where community=$1 and season='Summer' or season='Winter' and error is distinct from 1) part_1) part_2 group by season,day_section";
