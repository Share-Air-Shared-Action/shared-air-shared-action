...
$measurement_type = 'CO2 concentration';
...
(select season,to_char(time,'HH24')::integer  tod, measured_value from airterrier where community=$2 and (season='Summer' or season='Winter') and flag is null AND measurement_type = $1 ) part_1) part_2 group by season,day_section";
