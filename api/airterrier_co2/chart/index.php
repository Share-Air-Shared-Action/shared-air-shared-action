...
// Build the SQL query
$query = "SELECT time AS x, measured_value AS y FROM airterrier WHERE measurement_type = 'CO2 concentration' AND session_title = $1 AND season = $2 AND flag is null  ORDER BY time";
