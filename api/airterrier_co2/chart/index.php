...
WHERE measurement_type = 'CO2 concentration' AND session_title = $1 AND airterrier.season = $2 AND flag is null  ORDER BY airterrier.time";
...
$returnarray = ["x" => $xarray, "y" => $yarray, "text" => $textarray, "color" => $color,  "mode" => "markers", "type" => "scatter", "name" => "CO<sub>2</sub> (ppm)"];
