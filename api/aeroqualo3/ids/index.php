...
// Build the SQL query
$query = 'SELECT DISTINCT aeroqualo3.unit_id, stationarylocations.latitude, stationarylocations.longitude FROM aeroqualo3 INNER JOIN stationarylocations ON (aeroqualo3.unit_id = stationarylocations.unit_id)';
