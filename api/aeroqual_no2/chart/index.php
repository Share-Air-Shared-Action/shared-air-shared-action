...
// Build the SQL query
$query = 'SELECT date AS x, no2ppm AS y FROM aeroqualno2 WHERE unit_id = $1 AND season = $2 AND community = $3 AND error IS DISTINCT FROM 1 ORDER BY date';
...
$returnarray = ["x" => $xarray, "y" => $yarray, "mode" => "markers", "type" => "scatter", "name" => "NO<sub>2</sub> (ppb)"];
