...
(select season,to_char(date,'HH24')::integer tod, no2ppm from aeroqualno2 where community=$1 and (season='Summer' or season='Winter') and flag is null) part_1) part_2 group by season,day_section";
