...
// Build the SQL query
$query = 'select community, (sum(case when value < 12.0 then 1 else 0 end)*100)/count(*) as good, (sum(case when value > 12.0 and value < 35.4 then 1 else 0 end)*100)/count(*) as moderate, (sum(case when value > 35.4 and value < 55.4 then 1 else 0 end)*100)/count(*) as unhfsg, (sum(case when value > 55.4 and value < 150.4 then 1 else 0 end)*100)/count(*) as unhealthy, (sum(case when value > 150.4 and value < 250.4 then 1 else 0 end)*100)/count(*) as very_unhealthy, (sum(case when value > 250.4 then 1 else 0 end)*100)/count(*) as hazardous from metone where community=$1 and error is distinct from 1 AND type = $2 group by community';
