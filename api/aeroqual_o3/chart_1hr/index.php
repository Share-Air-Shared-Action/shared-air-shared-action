...
// Build the SQL query
$query = 'SELECT date AS x, o3ppm_avg AS y FROM aeroqualo3_15min WHERE unit_id = $1 AND season = $2 AND community = $3 ORDER BY date';
...
$returnarray = ["x" => $xarray, "y" => $yarray, "mode" => "markers", "type" => "scatter", "name" => "O<sub>3</sub> (ppm)"];
