...
// Build the SQL query
$query = 'SELECT DATE(date), avg(o3ppm) as average, max(o3ppm) as max, min(o3ppm) as min FROM aeroqualno2 WHERE unit_id = $1 AND season = $2 GROUP BY DATE(date) ORDER BY DATE(date)';
