...
(select season,to_char(date,'HH24')::integer tod, o3ppm from aeroqualo3 where community=$1 and (season='Summer' or season='Winter') and flag is null) part_1) part_2 group by season,day_section";
