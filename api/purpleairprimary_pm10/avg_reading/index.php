...
(select season,to_char(created_at,'HH24')::integer tod, pm10_cf_atm_ugm3 from purpleair where community=$1 and (season='Summer' or season='Winter') and flag is null) part_1) part_2 group by season,day_section";
