...
// Build the SQL query
$query = 'SELECT created_at AS x, pm10_cf_atm_ugm3 AS y FROM purpleair WHERE device_name = $1 AND season = $2 AND community = $3 AND error IS DISTINCT FROM 1 ORDER BY created_at';
