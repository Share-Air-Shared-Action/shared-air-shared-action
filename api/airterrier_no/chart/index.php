...
// Build the SQL query
$query = "SELECT time AS x, measured_value AS y FROM airterrier WHERE measurement_type = 'NO concentration' AND session_title = $1 AND season = $2 AND error IS DISTINCT FROM 1  ORDER BY time";
...
$returnarray = ["x" => $xarray, "y" => $yarray, "mode" => "markers", "type" => "scatter", "name" => "NO (ppb)"];
