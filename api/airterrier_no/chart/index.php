...
WHERE measurement_type = 'NO concentration' AND session_title = $1 AND airterrier.season = $2 AND flag is null  ORDER BY airterrier.time";
...
$returnarray = ["x" => $xarray, "y" => $yarray, "text" => $textarray, "color" => $color,  "mode" => "markers", "type" => "scatter", "name" => "NO (ppm)"];
