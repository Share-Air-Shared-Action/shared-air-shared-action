...
// Build the SQL query
$query = "SELECT DISTINCT session_title, SUBSTRING(session_title, 1, 2) as community, season FROM airterrier WHERE measurement_type = 'NO concentration' AND season = $1";
