...
// Build the SQL query
$query = 'SELECT community AS x, ROUND(CAST(AVG(pm1_cf_atm_ugm3) as NUMERIC),3) AS y FROM purpleairprimary WHERE season=$1 AND error IS distinct FROM 1 GROUP BY community';
