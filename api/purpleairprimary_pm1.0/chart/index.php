...
// Build the SQL query
$query = 'SELECT created_at AS x, pm1_cf_atm_ugm3 AS y FROM purpleair WHERE device_name = $1 AND season = $2 AND community = $3 AND flag is null ORDER BY created_at';
