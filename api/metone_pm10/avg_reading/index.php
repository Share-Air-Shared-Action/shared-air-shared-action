...
(select season,to_char(time,'HH24')::integer tod, value from metone where community=$1 and (season='Summer' or season='Winter') and flag is null AND type = $2) part_1) part_2 group by season,day_section";
